...
class UpdateCustomerTaxProfileRequest extends FormRequest
{
    public function authorize(): bool
    {
        if (! $this->user()?->administrator?->hasPermissionTo('tax-profiles.manage')) {
            return false;
        }
        ...
        return $taxProfile->customer_id === $customer->id;
    }
