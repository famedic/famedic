...
class StoreCustomerTaxProfileRequest extends FormRequest
{
    public function authorize(): bool
    {
        return (bool) $this->user()?->administrator?->hasPermissionTo('tax-profiles.manage');
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'rfc' => [
                ...
                'string',
                new IndividualRfc,
                Rule::unique('tax_profiles', 'rfc')->where(function ($query) use ($customer) {
                    return $query->where('customer_id', $customer->id)->whereNull('deleted_at');
                }),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'rfc.unique' => 'Este cliente ya tiene un perfil fiscal activo con este RFC.',
