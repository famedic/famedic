...
echo "1. CONTACTA A EFEVOOPAY y pregunta:\n";
echo "   '¿La tokenización en ambiente test hace cargos reales?'\n";
echo "   '¿Cuál es el monto mínimo para tokenización?'\n";
echo "   '¿Pueden proporcionar tarjetas de prueba que no hagan cargos reales?'\n\n";

echo "2. Para pruebas adicionales:\n";
echo "   - Usa montos de $0.01 MXN\n";
echo "   - Formato fecha: MMYY (ej: 3111 = Nov 2031)\n";
echo "   - Monitorea tu cuenta bancaria\n\n";

echo "3. Códigos importantes:\n";
echo "   - 00: Aprobado\n";
echo "   - 30: Error de formato\n";
echo "   - 05: No honrar (rechazado por banco)\n";