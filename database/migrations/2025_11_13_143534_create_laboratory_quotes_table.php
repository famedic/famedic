...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('laboratory_quotes', function (Blueprint $table) {
            ...
            $table->foreignId('appointment_id')->nullable()->constrained('laboratory_appointments');
            $table->string('purchase_id')->nullable();
            $table->json('items');
            $table->decimal('subtotal', 10, 2);
            $table->decimal('discount', 10, 2)->default(0);
            $table->decimal('total', 10, 2);
            $table->string('status')->default('pending_branch_payment');
    ...
    {
        Schema::dropIfExists('laboratory_quotes');
    }
};
