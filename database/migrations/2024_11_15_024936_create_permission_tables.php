...
return new class extends Migration
{
    ...
    public function up(): void
    {
                ...
                foreach ($permission as $name => $description) {
                    ...
                    if (count($permissionName) > 1) {
                        $parentPermissionName =
                            ...
                            implode(
                                '.',
                                array_slice($permissionName, 0, count($permissionName) - 1)
                            );
                        $parentPermission = Permission::where('name', $parentPermissionName)->sole();
                        Permission::create([
                            'name' => $category . '.' . $name,
        ...
        Role::create(['name' => 'Administrador'])->givePermissionTo($allPermissions);
    }
