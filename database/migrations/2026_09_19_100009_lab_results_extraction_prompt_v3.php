...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $exists = DB::table('ai_prompts')
            ...
            ->where('version', LaboratoryResultVisionPromptDefinition::VERSION_V3)
            ->exists();
        ...
        DB::table('ai_prompts')
            ->where('key', LaboratoryResultVisionPromptDefinition::KEY)
            ->whereIn('version', [
                LaboratoryResultVisionPromptDefinition::VERSION_V1,
        ...
        $record = LaboratoryResultVisionPromptDefinition::record(LaboratoryResultVisionPromptDefinition::VERSION_V3);
