...
return [
    ...
    */
    ...
    'activecampaign' => [
        ...
        'queue' => env('ACTIVE_CAMPAIGN_QUEUE_NAME', 'activecampaign'),
        ...
        'fields' => [
            ...
            'lab' => [
                'url_finalizar_compra' => active_campaign_env('ACTIVECAMPAIGN_FIELD_LAB_URL_FINALIZAR_COMPRA'),
                'paciente_lab' => active_campaign_env('ACTIVECAMPAIGN_FIELD_LAB_PACIENTE'),
                'sucursal_lab' => active_campaign_env('ACTIVECAMPAIGN_FIELD_LAB_SUCURSAL'),
                'google_maps_lab' => active_campaign_env('ACTIVECAMPAIGN_FIELD_LAB_GOOGLE_MAPS'),
                'direccion_lab' => active_campaign_env('ACTIVECAMPAIGN_FIELD_LAB_DIRECCION'),
                'fecha_cita_lab' => active_campaign_env('ACTIVECAMPAIGN_FIELD_LAB_FECHA_CITA'),
                'horario_cita_lab' => active_campaign_env('ACTIVECAMPAIGN_FIELD_LAB_HORARIO_CITA'),
                'folio_famedic' => active_campaign_env('ACTIVECAMPAIGN_FIELD_LAB_FOLIO_FAMEDIC'),
                'gda_consecutivo' => active_campaign_env('ACTIVECAMPAIGN_FIELD_LAB_GDA_CONSECUTIVO'),
