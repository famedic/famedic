...
<b>Tu cita quedó confirmada en {{ $laboratorio_marca }} sucursal {{ $branch_name }}</b> ✅
</p>

@if (! $has_purchase)
<p style="margin:0 0 12px;color:#92400e;background:#fef3c7;border:1px solid #fcd34d;border-radius:8px;padding:12px 14px;font-size:15px;line-height:1.5;">
Realiza el pago para la generación de folios que debes presentar en sucursal.
</p>
@endif
...
🔹 Consecutivo: <strong>{{ $has_purchase ? ($consecutivo ?? '—') : '(En el comprobante de pago)' }}</strong>
</p>
<p style="margin:0 0 4px;color:#3d4852;font-size:16px;line-height:1.5;">
🔹 Folio de orden: <strong>{{ $has_purchase ? ($folio_orden ?? '—') : '(En el comprobante de pago)' }}</strong>
</p>
<p style="margin:0 0 4px;color:#3d4852;font-size:16px;line-height:1.5;">
🔹 Paciente: <strong>{{ $nombre_paciente }}</strong>
</p>
<p style="margin:0 0 4px;color:#3d4852;font-size:16px;line-height:1.5;">
🔹 Fecha de nacimiento: <strong>{{ $fecha_nacimiento }}</strong>
</p>
...
Tu cita ya quedó registrada, pero está sujeta a que concretes el pago de tus estudios.
Una vez confirmado el pago, te compartiremos los folios e identificadores para presentar en sucursal.
</p>
@endif
...
<p style="margin:0 0 4px;color:#3d4852;font-size:16px;line-height:1.5;">• Llega 10 minutos antes</p>
<p style="margin:0 0 4px;color:#3d4852;font-size:16px;line-height:1.5;">• Lleva identificación oficial del paciente</p>
<p style="margin:0 0 20px;color:#3d4852;font-size:16px;line-height:1.5;">• Ten a la mano tu folio y los datos del paciente (arriba)</p>

<p style="margin:0 0 8px;color:#3d4852;font-size:16px;line-height:1.5;">
<strong>🚶‍♂️ 2. AL LLEGAR (PASO A PASO)</strong>
</p>
<p style="margin:0 0 12px;color:#3d4852;font-size:16px;line-height:1.5;">
1. Comparte tus identificadores
{{ $has_purchase ? '(Consecutivo, Folio y Paciente + Fecha de nacimiento)' : '((En el comprobante de pago))' }}
</p>
<p style="margin:0 0 20px;color:#3d4852;font-size:16px;line-height:1.5;">
...
@else
<p style="margin:0 0 12px;color:#3d4852;font-size:16px;line-height:1.5;">
Si necesitas ayuda, no pudiste realizar el pago o requieres cambios/cancelación, contáctanos y lo resolvemos contigo.
</p>
@endif
<p style="margin:0 0 12px;color:#3d4852;font-size:16px;line-height:1.5;">
&nbsp;&nbsp;&nbsp;Atención a clientes FAMEDIC: 📞 <b>812 860 1893</b>
</p>
<p style="margin:0 0 4px;color:#3d4852;font-size:16px;line-height:1.5;">Con gusto te acompañamos,</p>
