		...
		<div className="flex flex-wrap items-start justify-between gap-4">
			<div className="space-y-2">
				...
				<div>
					...
					<Heading className="mt-1">Cohorts & Retention</Heading>
					<Text className="mt-1 max-w-2xl text-sm text-zinc-500 dark:text-zinc-400">
						Retención, recurrencia, churn y LTV por cohortes de registro.
						Dashboard ejecutivo para Dirección y Marketing.
					</Text>
					{generatedAt ? (
