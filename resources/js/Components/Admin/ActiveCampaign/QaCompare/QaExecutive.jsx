...
export default function QaExecutive({ executive = null }) {
	if (!executive) {
		return (
	...
	return (
		<section className="space-y-4">
			...
			<div className="grid gap-4 xl:grid-cols-2">
				<MiniBar
					title="Configuraciones iguales / distintas"
					description="Conteo por estado de comparación."
					data={executive.equal}
					color={DASHBOARD_COLORS.blue}
				/>
				<MiniBar
					title="Configuraciones distintas"
					description="Muestra de filas con drift confirmado."
					data={executive.different}
					color={DASHBOARD_COLORS.orange}
				/>
				<MiniBar
					title="Integraciones"
					description="Distribución de estado en categoría Integraciones."
					data={executive.integrations}
					color={DASHBOARD_COLORS.purple}
				/>
				<ChartCard
					title="Feature Flags"
					description="1 = iguales · 0 = distintas/pendientes."
				>
