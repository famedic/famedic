...
export function TableHead({ className, ...props }) {
	return (
		<thead
			{...props}
			className={clsx(className, "text-zinc-500 dark:text-slate-400")}
		/>
	);
}
		...
		<TableRowContext.Provider value={{ href, target, title }}>
			<tr
				...
				className={clsx(
					className,
					href &&
						"has-[[data-row-link][data-focus]]:outline has-[[data-row-link][data-focus]]:outline-2 has-[[data-row-link][data-focus]]:-outline-offset-2 has-[[data-row-link][data-focus]]:outline-famedic-dark dark:focus-within:bg-white/[2.5%] dark:has-[[data-row-link][data-focus]]:outline-famedic-light",
					striped &&
...
export function TableCell({ className, children, ...props }) {
	...
	return (
		<td
			...
			className={clsx(
				className,
				"relative px-4 first:pl-[var(--gutter,theme(spacing.2))] last:pr-[var(--gutter,theme(spacing.2))] dark:text-slate-500",
