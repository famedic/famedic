...
const base = [
	...
	// Focus ring
	"group-data-[focus]:outline group-data-[focus]:outline-2 group-data-[focus]:outline-offset-2 group-data-[focus]:outline-famedic-dark dark:group-data-[focus]:outline-famedic-light",
	// Disabled state
...
export function Checkbox({ color = "dark/slate", className, ...props }) {
	return (
		<Headless.Checkbox
			data-slot="control"
			{...props}
