		...
		<Headless.Listbox {...props} multiple={false}>
			<Headless.ListboxButton
				...
				className={clsx([
					...
					"focus:outline-none",
					// Focus ring
					"after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-inset after:ring-transparent after:data-[focus]:ring-2 after:data-[focus]:ring-famedic-dark dark:after:data-[focus]:ring-famedic-light",
					// Disabled state
			...
			>
				<Headless.ListboxSelectedOption
					...
					placeholder={
						placeholder && (
							<span className="block truncate text-zinc-500 dark:text-slate-500">
								{placeholder}
							</span>
						)
					}
					className={clsx([
						...
						// Border
						"border border-zinc-950/10 group-data-[hover]:border-zinc-950/20 dark:border-slate-800 dark:group-data-[hover]:border-slate-700",
						// Focus ring
						"after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-transparent sm:after:group-data-[active]:ring-2 sm:after:group-data-[active]:ring-famedic-dark dark:sm:after:group-data-[active]:ring-famedic-light",
						// Background color
				...
				<span className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
					<svg
						className="size-5 stroke-zinc-500 group-data-[disabled]:stroke-zinc-600 sm:size-4 dark:stroke-slate-400 forced-colors:stroke-[CanvasText]"
						viewBox="0 0 16 16"
						aria-hidden="true"
						fill="none"
					>
			...
			<Headless.ListboxOptions
				...
				className={clsx(
					...
					// Base styles
					"isolate w-max min-w-[calc(var(--button-width))] select-none scroll-py-1 rounded-xl p-1",
				...
				return (
					<div
						className={clsx(
							...
							// Focus
							"outline-none data-[focus]:bg-famedic-dark data-[focus]:text-white dark:data-[focus]:bg-famedic-light",
							// Forced colors mode
...
export function ListboxDescription({ className, children, ...props }) {
	return (
		<span
			...
			className={clsx(
				className,
				"flex flex-1 overflow-hidden text-zinc-500 before:w-2 before:min-w-0 before:shrink group-data-[focus]/option:text-white dark:text-slate-400",
			)}
		>
