...
const colors = {
	...
	"famedic-lime":
		"bg-famedic-lime/80 text-lime-800 group-data-[hover]:bg-lime-400/30 dark:bg-famedic-lime/10 dark:text-famedic-lime dark:group-data-[hover]:bg-lime-400/15",

	"famedic-dark":
		"bg-famedic-dark text-white [&>[data-slot=icon]]:fill-famedic-lime  group-data-[hover]:bg-famedic-dark/80",
	famedic:
		"bg-famedic-dark text-white [&>[data-slot=icon]]:fill-famedic-lime [&>[data-slot=icon]]:dark:fill-famedic-darker group-data-[hover]:bg-famedic-dark/80 dark:bg-famedic-lime dark:text-famedic-darker dark:group-data-[hover]:bg-famedic-lime/80",
	"famedic-light":
		"bg-famedic-dark text-white dark:bg-famedic-lime dark:text-famedic-dark ",
	green: "bg-green-500/15 text-green-700 group-data-[hover]:bg-green-500/25 dark:bg-green-500/10 dark:text-green-200 dark:group-data-[hover]:bg-green-500/20",
	emerald:
...
export function Badge({ color = "famedic", className, ...props }) {
	return (
		<span
			{...props}
			className={clsx(
				className,
				"inline-flex items-center gap-x-1.5 rounded-md px-1.5 py-0.5 font-poppins text-sm/5 font-medium sm:text-xs/5 forced-colors:outline",
				colors[color],
			)}
		/>
	);
