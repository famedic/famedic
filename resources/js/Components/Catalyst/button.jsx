...
const styles = {
	base: [
		// Base
		"relative isolate inline-flex items-center justify-center gap-x-2 border text-base/6 font-semibold font-poppins",
		// Sizing
		"px-[calc(theme(spacing[3.5])-1px)] py-[calc(theme(spacing[2.5])-1px)] sm:px-[calc(theme(spacing.3)-1px)] sm:py-[calc(theme(spacing[1.5])-1px)] sm:text-sm/6",
		// Focus
		"focus:outline-none data-[focus]:outline data-[focus]:outline-2 data-[focus]:outline-offset-2 data-[focus]:outline-famedic-dark dark:data-[focus]:outline-white",
		// Disabled
	...
	colors: {
		...
		slate: [
			...
			"dark:text-white dark:[--btn-bg:var(--color-slate-600)] dark:[--btn-hover-overlay:var(--color-white)]/5",
			"[--btn-icon:var(--color-slate-400)] data-active:[--btn-icon:var(--color-slate-300)] data-hover:[--btn-icon:var(--color-slate-300)]",
		],
		famedic: [
			"text-white [--btn-bg:theme(colors.famedic.dark)] [--btn-border:theme(colors.famedic.dark/90%)] [--btn-hover-overlay:theme(colors.white/10%)]",
			"dark:text-famedic-darker dark:[--btn-bg:theme(colors.famedic.lime)] dark:[--btn-hover-overlay:theme(colors.famedic.darker/10%)]",
			"[--btn-icon:theme(colors.famedic.lime)] dark:[--btn-icon:theme(colors.famedic.darker)] data-[active]:[--btn-icon:theme(colors.famedic.lime)] dark:data-[active]:[--btn-icon:theme(colors.famedic.darker)]  dark:data-[hover]:[--btn-icon:theme(colors.famedic.darker)]",
		],
		"famedic-light": [
			"text-white [--btn-bg:theme(colors.famedic.light)] [--btn-border:theme(colors.famedic.light/90%)] [--btn-hover-overlay:theme(colors.white/10%)]",
			"[--btn-icon:theme(colors.famedic.lime)] dark:[--btn-icon:theme(colors.white)] data-[active]:[--btn-icon:theme(colors.famedic.dark)] dark:data-[active]:[--btn-icon:theme(colors.white)] dark:data-[hover]:[--btn-icon:theme(colors.white)]",
		],
		"famedic-dark": [
			"text-white [--btn-bg:theme(colors.famedic.dark)] [--btn-border:theme(colors.famedic.dark/90%)] [--btn-hover-overlay:theme(colors.white/10%)]",
			"[--btn-icon:theme(colors.famedic.lime)] data-[active]:[--btn-icon:theme(colors.famedic.lime)] data-[hover]:[--btn-icon:theme(colors.famedic.lime)]",
		],
		"famedic-lime": [
			"text-famedic-darker [--btn-hover-overlay:theme(colors.famedic.darker/10%)] [--btn-bg:theme(colors.famedic.lime)] [--btn-border:theme(colors.famedic.lime/80%)]",
			"[--btn-icon:theme(colors.famedic.darker)] ",
		],
		light: [
...
export const Button = forwardRef(function Button(
	{ color, outline, plain, className, children, shape = "square", ...props },
	ref,
) {
	const shapeStyles = shape === "rounded" ? shapeRounded : shapeSquare;
