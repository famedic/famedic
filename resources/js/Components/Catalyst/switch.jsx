	...
	return (
		<Headless.Switch
			...
			className={clsx(
				...
				// Focus
				"data-[focus]:outline-famedic-dark dark:data-[focus]:outline-famedic-light focus:outline-none data-[focus]:outline data-[focus]:outline-2 data-[focus]:outline-offset-2",
				// Hover
