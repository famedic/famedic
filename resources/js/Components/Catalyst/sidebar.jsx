...
export function SidebarHeader({ className, ...props }) {
	return (
		<div
			...
			className={clsx(
				className,
				"flex flex-col border-b border-zinc-950/5 p-4 dark:border-gray-800 [&>[data-slot=section]+[data-slot=section]]:mt-2.5",
			)}
		/>
	);
}
...
export function SidebarFooter({ className, ...props }) {
	return (
		<div
			...
			className={clsx(
				className,
				"flex flex-col border-t border-zinc-950/5 p-4 dark:border-gray-800 [&>[data-slot=section]+[data-slot=section]]:mt-2.5",
			)}
		/>
	);
}
...
export function SidebarDivider({ className, ...props }) {
	return (
		<hr
			...
			className={clsx(
				className,
				"my-4 border-t border-zinc-950/5 lg:-mx-4 dark:border-gray-800",
			)}
		/>
	);
}
