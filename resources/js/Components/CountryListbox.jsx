...
const ISO3166_1_alpha_2_countries = [
	{ code: "AD", name: "Andorra" },
	{ code: "AE", name: "United Arab Emirates" },
	{ code: "AFRUN", name: "African Union" },
	{ code: "AG", name: "Antigua and Barbuda" },
	{ code: "AI", name: "Anguilla" },
	{ code: "AL", name: "Albania" },
	{ code: "AM", name: "Amernia" },
	{ code: "AMS", name: "Amsterdam" },
	{ code: "AO", name: "Angola" },
	{ code: "AQ", name: "Antartctica" },
	...
	{ code: "CD", name: "Democratis Republic of Congo" },
	...
	{ code: "GR", name: "Greece" },
	{ code: "GS", name: "South Gerogia and the South Sandwich Islands" },
	...
	{ code: "KN-SK", name: "Saint Kitts and Nevis" },
	...
	{ code: "PA", name: "Panama" },
	{ code: "PE", name: "Peru" },
	{ code: "PF", name: "French Polyesia" },
	{ code: "PG", name: "Papua New Guinea" },
	{ code: "PH", name: "Phillippines (the)" },
	...
	{ code: "SH", name: "Saint Helena, Ascension Island, Traistan da Cunha" },
	...
	{ code: "UNASUR", name: "Union of South American Nations" },
...
export default function CountryListbox({ className, setCountry, country }) {
	return (
		<>
			<Listbox
				className={className}
				...
				onChange={setCountry}
			>
				{ISO3166_1_alpha_2_countries.map((country) => (
